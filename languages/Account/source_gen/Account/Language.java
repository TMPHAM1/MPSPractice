...
import Account.structure.ConceptPresentationAspectImpl;

public class Language extends LanguageRuntime {
  private final SLanguageId myId;

  public Language() {
    myId = SLanguageId.deserialize("1b5f79a9-a646-4e86-b0dc-aa13ea6dc8d2");
  }
  ...
  protected <T extends ILanguageAspect> T createAspect(Class<T> aspectClass) {
    ...
    if (aspectClass == StructureAspectDescriptor.class) {
      return aspectClass.cast(new Account.structure.StructureAspectDescriptor());
    }
